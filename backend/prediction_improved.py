...
for _, row in team_stats_2025.iterrows():
    ...
    if not team_games.empty:
        ...
        team_id = team_games.iloc[0]['hometeamId'] if team_games.iloc[0]['hometeamName'] == team_name.split()[-1] else team_games.iloc[0]['awayteamId']
...
for _, game in games_2025.iterrows():
    ...
    if home_team_name and away_team_name:
        ...
        features = {
            ...
            'tov_per_100_diff': away_stats['tov_per_100_poss'] - home_stats['tov_per_100_poss'],  # Lower TOV is better
            ...
            # Efficiency ratios
            'efg_pct_diff': ((home_stats['fg_per_100_poss'] + 0.5 * home_stats['x3p_per_100_poss']) / home_stats['fga_per_100_poss']) - 
                           ((away_stats['fg_per_100_poss'] + 0.5 * away_stats['x3p_per_100_poss']) / away_stats['fga_per_100_poss']),
            
            # Pace indicators
            'pace_diff': (home_stats['fga_per_100_poss'] + home_stats['fta_per_100_poss'] * 0.44 + home_stats['tov_per_100_poss']) - 
                        (away_stats['fga_per_100_poss'] + away_stats['fta_per_100_poss'] * 0.44 + away_stats['tov_per_100_poss'])
        }
...
X_train, X_test, y_train, y_test = train_test_split(
    features_df, outcomes_series, test_size=0.2, random_state=42, stratify=outcomes_series
)
...
prediction_features = {
    ...
    'fga_per_100_diff': team1_stats['fga_per_100_poss'] - team2_stats['fga_per_100_poss'],
    'x3p_per_100_diff': team1_stats['x3p_per_100_poss'] - team2_stats['x3p_per_100_poss'],
    'x3pa_per_100_diff': team1_stats['x3pa_per_100_poss'] - team2_stats['x3pa_per_100_poss'],
    'x2p_per_100_diff': team1_stats['x2p_per_100_poss'] - team2_stats['x2p_per_100_poss'],
    'x2pa_per_100_diff': team1_stats['x2pa_per_100_poss'] - team2_stats['x2pa_per_100_poss'],
    'ft_per_100_diff': team1_stats['ft_per_100_poss'] - team2_stats['ft_per_100_poss'],
    'fta_per_100_diff': team1_stats['fta_per_100_poss'] - team2_stats['fta_per_100_poss'],
    'orb_per_100_diff': team1_stats['orb_per_100_poss'] - team2_stats['orb_per_100_poss'],
    'drb_per_100_diff': team1_stats['drb_per_100_poss'] - team2_stats['drb_per_100_poss'],
    'trb_per_100_diff': team1_stats['trb_per_100_poss'] - team2_stats['trb_per_100_poss'],
    'ast_per_100_diff': team1_stats['ast_per_100_poss'] - team2_stats['ast_per_100_poss'],
    'stl_per_100_diff': team1_stats['stl_per_100_poss'] - team2_stats['stl_per_100_poss'],
    'blk_per_100_diff': team1_stats['blk_per_100_poss'] - team2_stats['blk_per_100_poss'],
    'tov_per_100_diff': team2_stats['tov_per_100_poss'] - team1_stats['tov_per_100_poss'],
    'pf_per_100_diff': team1_stats['pf_per_100_poss'] - team2_stats['pf_per_100_poss'],
    'pts_per_100_diff': team1_stats['pts_per_100_poss'] - team2_stats['pts_per_100_poss'],
    'efg_pct_diff': ((team1_stats['fg_per_100_poss'] + 0.5 * team1_stats['x3p_per_100_poss']) / team1_stats['fga_per_100_poss']) - 
                   ((team2_stats['fg_per_100_poss'] + 0.5 * team2_stats['x3p_per_100_poss']) / team2_stats['fga_per_100_poss']),
    'pace_diff': (team1_stats['fga_per_100_poss'] + team1_stats['fta_per_100_poss'] * 0.44 + team1_stats['tov_per_100_poss']) - 
                (team2_stats['fga_per_100_poss'] + team2_stats['fta_per_100_poss'] * 0.44 + team2_stats['tov_per_100_poss'])
}
...
print(f"{team1} (Home):")
for stat in ['fg_percent', 'x3p_percent', 'ft_percent', 'trb_per_100_poss', 'ast_per_100_poss', 'pts_per_100_poss']:
